...
{
    public class BctHpsaService
    {
        private readonly string _conexionBCT;
        public BctHpsaService(IConfiguration configuration)
        {
            _conexionBCT = configuration.GetConnectionString("BCT_HP") ?? throw new ArgumentNullException(nameof(configuration), "Connection string 'BCT_HP' not found.");
        }
