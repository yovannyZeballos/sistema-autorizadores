...
namespace SGP.Api.Services.SgpService
{
    public class SgpService
    {
        ...
        //    string query = @"SELECT ""COD_EMPRESA"", ""NOM_EMPRESA"", ""COD_SOCIEDAD"", ""COD_EMPRESA_OFI"", ""RUC""
        //                    FROM ""SGP"".""MAE_EMPRESA"";";

        //    using (NpgsqlConnection connection = new NpgsqlConnection(_conexionSGP))
        //    {
        ...
        //            catch (Exception ex)
        //            {
        //                throw new Exception("Error al obtener lista empresas::" + ex.Message);
        //            }
        //        }
        //    }
        //}
        ...
        //public List<CadenaDto> ObtenerCadenas(string codEmpresa)
        //{
        //    List<CadenaDto> listaCadenas = [];

        //    string query = @"SELECT ""COD_EMPRESA"", ""COD_CADENA"", ""NOM_CADENA"", ""CAD_NUMERO""
        //                        FROM ""SGP"".""MAE_CADENA""
        //                        WHERE ""COD_EMPRESA"" = :COD_EMPRESA;";
        ...
        //                        CodCadena = reader["COD_CADENA"].ToString(),
        //                        NomCadena = reader["NOM_CADENA"].ToString(),
        //                        CadNumero = Convert.ToInt32(reader["CAD_NUMERO"])
        //                    };
        ...
        //            catch (Exception ex)
        //            {
        //                throw new Exception("Error al obtener lista cadenas::" + ex.Message);
        //            }
        //        }
        //    }
        //}
        ...
        //    string query = @"SELECT ""COD_EMPRESA"", ""COD_CADENA"", ""COD_REGION"", ""COD_ZONA"", ""COD_LOCAL""
        //                    FROM ""SGP"".""MAE_LOCAL""
        //                    WHERE ""COD_EMPRESA"" = :COD_EMPRESA AND ""COD_CADENA"" = :COD_CADENA AND ""COD_LOCAL"" = :COD_LOCAL;";
        ...
        //            {
        //                command.Parameters.AddWithValue(":COD_EMPRESA", codEmpresa);
        //                command.Parameters.AddWithValue(":COD_CADENA", codCadena);
        //                command.Parameters.AddWithValue(":COD_LOCAL", codLocal);
        ...
        //            string query = @"INSERT INTO ""SGP"".""MAE_LOCAL""
        //                            (""COD_EMPRESA"", ""COD_CADENA"", ""COD_REGION"", ""COD_ZONA"", ""COD_LOCAL"", ""NOM_LOCAL"", ""TIP_ESTADO"", 
        //                                ""COD_LOCAL_PMM"", ""COD_LOCAL_OFIPLAN"", ""NOM_LOCAL_OFIPLAN"", ""COD_LOCAL_SUNAT"", ""TIP_LOCAL"", 
        //                                ""FEC_APERTURA"", ""USU_CREACION"", ""FEC_CREACION"")
        //                            VALUES(:COD_EMPRESA, :COD_CADENA, :COD_REGION, :COD_ZONA, :COD_LOCAL, :NOM_LOCAL, :TIP_ESTADO, 
        ...
        //                //Console.WriteLine($"CoEmpr: {datos.CO_EMPR}, DeNomb: {datos.DE_NOMB}, CodigoOfisis: {datos.CODIGO_OFISIS}");

        //                if (local.LOC_NUMEROPMM.ToString() == "")
        //                {
        //                    local.LOC_NUMEROPMM = "0";
        //                }

        //                command.Parameters.AddWithValue(":COD_EMPRESA", local.COD_EMPRESA);
        //                command.Parameters.AddWithValue(":COD_CADENA", local.COD_CADENA);
        //                command.Parameters.AddWithValue(":COD_REGION", "01");

        //                if (local.COD_EMPRESA == "06")
        //                {
        //                    command.Parameters.AddWithValue(":COD_ZONA", "00");
        //                }
        //                else
        //                {
        //                    command.Parameters.AddWithValue(":COD_ZONA", "01");
        //                }

        //                command.Parameters.AddWithValue(":COD_LOCAL", local.LOC_NUMERO);
        //                command.Parameters.AddWithValue(":NOM_LOCAL", local.LOC_DESCRIPCION);
        //                command.Parameters.AddWithValue(":TIP_ESTADO", local.LOC_ACTIVO);
        //                command.Parameters.AddWithValue(":COD_LOCAL_PMM", Convert.ToInt32(local.LOC_NUMEROPMM));
        //                command.Parameters.AddWithValue(":COD_LOCAL_OFIPLAN", "0");
        //                command.Parameters.AddWithValue(":NOM_LOCAL_OFIPLAN", string.Empty);
        //                command.Parameters.AddWithValue(":COD_LOCAL_SUNAT", "0");
        //                command.Parameters.AddWithValue(":TIP_LOCAL", local.LOC_TIPO);
        //                command.Parameters.AddWithValue(":FEC_APERTURA", (object)local.LOC_FINICIO ?? DBNull.Value);
        //                command.Parameters.AddWithValue(":USU_CREACION", "AppSync");
        //                command.Parameters.AddWithValue(":FEC_CREACION", DateTime.Now);
        ...
        //            string query = @"UPDATE ""SGP"".""MAE_LOCAL""
        //                                SET ""NOM_LOCAL""=@NomLocal, ""FEC_APERTURA""=@FecApertura, ""USU_MODIFICA""=@UsuModifica, ""FEC_MODIFICA""=@FecModifica,
        //                                    ""CEN_COSTO""=@CentroCosto, ""COD_SAP""=@CodSap
        //                                WHERE ""COD_LOCAL""=@CodLocal AND ""COD_EMPRESA"" NOT IN ('08','09','10','11');";

        //            using (NpgsqlCommand command = new NpgsqlCommand(query, connection))
        //            {
        //                command.CommandText = query;

        //                command.Parameters.AddWithValue("@NomLocal", local.LOC_DESCRIPCION);
        //                command.Parameters.AddWithValue("@FecApertura", local.LOC_FINICIO ?? (object)DBNull.Value);
        //                command.Parameters.AddWithValue("@UsuModifica", "AppSync");
        //                command.Parameters.AddWithValue("@FecModifica", DateTime.Now);
        //                command.Parameters.AddWithValue("@CentroCosto", local.LOC_CENTROCOSTO);
        //                command.Parameters.AddWithValue("@CodSap", local.LOC_NUMEROSAP);
        //                command.Parameters.AddWithValue("@CodLocal", local.LOC_NUMERO);
        ...
        //public List<LocalBctDTO> ObtenerLocalesParaBct()
        //{
        //    List<LocalBctDTO> listaCadenas = [];

        //    string query = @"SELECT  ml.""COD_LOCAL"" as ""codigo"", ml.""NOM_LOCAL"" as ""descripcion"", ml.""IP"" as ""ip"", me.""RUC"" as ""ruc_emisor""
        //                        FROM ""SGP"".""MAE_LOCAL"" ml
        //                            INNER JOIN ""SGP"".""MAE_EMPRESA"" me on ml.""COD_EMPRESA""  = me.""COD_EMPRESA"" 
        //                        WHERE me.""RUC"" = '20608280333';";
        ...
        //            catch (Exception ex)
        //            {
        //                throw new Exception("Error al obtener lista locales::" + ex.Message);
        //            }
        //        }
        //    }
        //}      
        ...
        //            string query = @"UPDATE ""SGP"".""PROCESO_PARAM_XEMP""
        //                           SET ""VAL_PARAMETRO"" = @Fecha
        //                           WHERE ""COD_PARAMETRO"" = '09'
        //                           AND ""COD_PROCESO"" IN (29)
        //                           AND ""COD_EMPRESA"" = @CodEmpresa";
        ...
        //        catch (Exception ex)
        //        {
        //            throw new Exception("Error al actualizar parametros fecha negocio::" + ex.Message);
        //        }
        //    }
        //}
        ...
        //        catch (Exception ex)
        //        {
        //            throw new Exception("Error al actualizar parametros estado conexion::" + ex.Message);
        //        }
        //    }
        //}
        ...
        //public string InsertarTickeGlpi(Ticket ticket)
        //{
        //    using (NpgsqlConnection connection = new NpgsqlConnection(_conexionSGP))
        //    {
        //        try
        ...
        //            string query = @"INSERT INTO ""SGP"".""TICKET""
        //                        (id, fechaproceso, titulo, estado, encuestasatisfaccionfechacreacion, solicitante, tipo, fechaapertura, ultimaactualizacion, categoria, 
        //                            grupotecnicos, tecnico, localizaciones, fuentessolicitantes, prioridad, entidad, fechasolucion, elementosasociados, 
        //                            tiempoadueñarse, tiemposolucion, autor, tiemposolucionestadisticas, tiempoatenderservicio, incidentessociedad1, 
        //                            solicitudsociedad2, incidentesaplicacionprograma, tiempoespera, tipotarea, gruposolicitante) 
        //                        VALUES (
        //                            @Id, @FechaProceso, @Titulo, @Estado, @EncuestaSatisfaccionFechaCreacion, @Solicitante, @Tipo, @FechaApertura, 
        //                            @UltimaActualizacion, @Categoria, @GrupoTecnicos, @Tecnico, @Localizaciones, 
        //                            @FuentesSolicitantes, @Prioridad, @Entidad, @FechaSolucion, @ElementosAsociados, 
        //                            @TiempoAdueñarse, @TiempoSolucion, @Autor, @TiempoSolucionEstadisticas, 
        //                            @TiempoAtenderServicio, @IncidentesSociedad1, @SolicitudSociedad2, 
        //                            @IncidentesAplicacionPrograma, @TiempoEspera, @TipoTarea, @GrupoSolicitante
        //                        );";
        ...
        //                command.Parameters.AddWithValue("@EncuestaSatisfaccionFechaCreacion", ticket.EncuestaSatisfaccionFechaCreacion);
        //                command.Parameters.AddWithValue("@Solicitante", ticket.Solicitante);
        //                command.Parameters.AddWithValue("@Tipo", ticket.Tipo);
        //                command.Parameters.AddWithValue("@FechaApertura", ticket.FechaApertura);
        //                command.Parameters.AddWithValue("@UltimaActualizacion", ticket.UltimaActualizacion);
        //                command.Parameters.AddWithValue("@Categoria", ticket.Categoria);
        //                command.Parameters.AddWithValue("@GrupoTecnicos", ticket.GrupoTecnicos);
        //                command.Parameters.AddWithValue("@Tecnico", ticket.Tecnico);
        //                command.Parameters.AddWithValue("@Localizaciones", ticket.Localizaciones);
        //                command.Parameters.AddWithValue("@FuentesSolicitantes", ticket.FuentesSolicitantes);
        //                command.Parameters.AddWithValue("@Prioridad", ticket.Prioridad);
        //                command.Parameters.AddWithValue("@Entidad", ticket.Entidad);
        //                command.Parameters.AddWithValue("@FechaSolucion", ticket.FechaSolucion);
        //                command.Parameters.AddWithValue("@ElementosAsociados", ticket.ElementosAsociados);
        //                command.Parameters.AddWithValue("@TiempoAdueñarse", ticket.TiempoAdueñarse);
        //                command.Parameters.AddWithValue("@TiempoSolucion", ticket.TiempoSolucion);
        //                command.Parameters.AddWithValue("@Autor", ticket.Autor);
        //                command.Parameters.AddWithValue("@TiempoSolucionEstadisticas", ticket.TiempoSolucionEstadisticas);
        //                command.Parameters.AddWithValue("@TiempoAtenderServicio", ticket.TiempoAtenderServicio);
        //                command.Parameters.AddWithValue("@IncidentesSociedad1", ticket.IncidentesSociedad1);
        //                command.Parameters.AddWithValue("@SolicitudSociedad2", ticket.SolicitudSociedad2);
        //                command.Parameters.AddWithValue("@IncidentesAplicacionPrograma", ticket.IncidentesAplicacionPrograma);
        //                command.Parameters.AddWithValue("@TiempoEspera", ticket.TiempoEspera);
        //                command.Parameters.AddWithValue("@TipoTarea", ticket.TipoTarea);
        //                command.Parameters.AddWithValue("@GrupoSolicitante", ticket.GrupoSolicitante);
        ...
        //        catch (Exception ex)
        //        {
        //            throw new Exception("Error al InsertarTickeGlpi ::" + ex.Message);
        //        }
        //    }
        //}
        ...
        //                command.Parameters.AddWithValue(":COD_EMPRESA", codEmpresa);
        //                command.Parameters.AddWithValue(":COD_PROCESO", codProceso);
        //                command.Parameters.AddWithValue(":COD_PARAMETRO", codParametro);
        ...
        //                    param = new()
        //                    {
        //                        CodProceso = Convert.ToInt32(reader["COD_PROCESO"]),
        //                        CodEmpresa = reader["COD_EMPRESA"].ToString(),
        //                        CodParametro = reader["COD_PARAMETRO"].ToString(),
        //                        NomParametro = reader["NOM_PARAMETRO"].ToString(),
        //                        ValParametro = reader["VAL_PARAMETRO"].ToString()
        ...
        //            catch (Exception ex)
        //            {
        //                throw new Exception("Error al obtener lista parametros::" + ex.Message);
        //            }
        //        }
        //    }
        //}
        ...
        //            string query = @"INSERT INTO ""SGP"".""MON_BCT_CT""
        //                            (""COD_EMPRESA"", ""FECHA_HORA"", ""FECHA"", ""HORA"", ""MINUTO"", ""CANTIDAD"", ""LIMITE"")
        //                            VALUES(:COD_EMPRESA, :FECHA_HORA, :FECHA, :HORA, :MINUTO, :CANTIDAD, :LIMITE);";
