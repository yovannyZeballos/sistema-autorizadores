                        ...
                        for (int row = 2; row <= rowCount; row++)
                        {
                            try
                            {
                                var rowKardex = new InvKardex
                                {
                                    ...
                                    OrigenId = Convert.ToInt32(worksheet.Cell(row, columnMapping["ORIGEN_ID"]).GetString()),
                                    DestinoId = Convert.ToInt32(worksheet.Cell(row, columnMapping["DESTINO_ID"]).GetString()),
