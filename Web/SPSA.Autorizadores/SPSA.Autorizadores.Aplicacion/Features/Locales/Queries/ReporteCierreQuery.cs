...
{
	public class ReporteCierreQuery : IRequest<ListarComunDTO<Dictionary<string, object>>>
	{
	...
	public class ReporteCierreHandler : IRequestHandler<ReporteCierreQuery, ListarComunDTO<Dictionary<string, object>>>
	{
		private readonly IRepositorioCajaCierre _repositorioCajaCierre;

		public ReporteCierreHandler(IRepositorioCajaCierre repositorioCajaCierre)
		{
			_repositorioCajaCierre = repositorioCajaCierre;
		}

		public async Task<ListarComunDTO<Dictionary<string, object>>> Handle(ReporteCierreQuery request, CancellationToken cancellationToken)
		{
