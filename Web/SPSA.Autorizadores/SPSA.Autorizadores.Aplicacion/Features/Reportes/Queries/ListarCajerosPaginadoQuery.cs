...
{
    public class ListarCajerosPaginadoQuery : IRequest<ListarComunDTO<Dictionary<string, object>>>
    {
    ...
    public class ListarCajerosPaginadoHandler : IRequestHandler<ListarCajerosPaginadoQuery, ListarComunDTO<Dictionary<string, object>>>
    {
        private readonly IRepositorioReportes _repositorioReportes;

        public ListarCajerosPaginadoHandler(IRepositorioReportes repositorioReportes)
        {
            _repositorioReportes = repositorioReportes;
        }

        public async Task<ListarComunDTO<Dictionary<string, object>>> Handle(ListarCajerosPaginadoQuery request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var dt = await _repositorioReportes.ListarCajerosPaginadoAsync(
                    request.StartRow,
                    endRow
                );
