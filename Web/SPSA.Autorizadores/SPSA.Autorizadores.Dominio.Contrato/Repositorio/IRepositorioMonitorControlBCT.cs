...
namespace SPSA.Autorizadores.Dominio.Contrato.Repositorio
{
	...
	{
		Task<List<MonitorControlBCT>> ObtenerHorarioSucursalCT2Spsa(string fecha, int local);		
        ...
        Task<List<MonitorControlBCT>> ObtenerHorarioSucursalBCTSpsa(string fecha, int sucursal);
