...
{
    public class MaeColaboradorExtController : Controller
    {
        private readonly IMediator _mediator;

        public MaeColaboradorExtController(IMediator mediator)
        {
            _mediator = mediator;
        }

        // GET: Maestros/MaeColaborador
        ...
        [HttpPost]
        public async Task<JsonResult> Obtener(ObtenerMaeColaboradorExtQuery request)
        {
        ...
        {
            var respuesta = await _mediator.Send(new DescargarPlantillasCommand { Carpeta = "Plantilla_ColaboradorExt" });
            return Json(respuesta);
        }
    }
}