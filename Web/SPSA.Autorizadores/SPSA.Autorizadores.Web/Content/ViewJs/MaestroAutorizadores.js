var urlListarAutorizadores = baseUrl + 'Reportes/MaestroAutorizadores/Descargar';
var urlListarAutorizadoresPaginado = baseUrl + 'Reportes/MaestroAutorizadores/ListarPaginado';

var dataTableRegistros = null;

var MaestroAutorizadores = function () {
    ...
    var visualizarDataTable = function () {
        ...
        $.ajax({
            url: urlListarAutorizadoresPaginado,
            type: "POST",
